  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="display-heading text-2xl">
            Bird Cost Contribution
          </CardTitle>
          <CardDescription>
            Bird acquisition and vaccination costs applied per egg.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="rounded-lg border border-border/70 bg-muted/35 p-4">
            <div className="flex items-center justify-between gap-3">
              <p className="text-sm font-medium">Current Bird Cost per Egg</p>
              <p className="display-heading text-3xl leading-none">
                ₦{costBreakdown.birdCost.toFixed(2)}
              </p>
            </div>
            <p className="mt-3 text-xs text-muted-foreground">
              Add or update bird cost batches from House Management to adjust
              this value.
            </p>
          </div>
        </CardContent>
